package com.maruf.tech.agecalulatorbangla.data.sqlite;
...
public class DbConstants implements BaseColumns {
    ...
    public static final String POST_SUB_TITLE = "post_sub_title";
    ...
    public static final String SQL_CREATE_FAVOURITE_ENTRIES =
            "CREATE TABLE " + FAVORITE_TABLE_NAME + " (" +
                    ...
                    POST_SUB_TITLE + TEXT_TYPE + COMMA_SEP +
                    POST_DETAILS + TEXT_TYPE + COMMA_SEP +
                    POST_IMAGE_URL + TEXT_TYPE +
                    " )";
